...
$sentenciaProductos = $base_de_datos->prepare("SELECT p.idflortempo, p.tipoflor ,p.precio, pv.cantidad
FROM flor_temporada p
INNER JOIN 
productos_vendidos pv
ON p.idflortempo = pv.id_producto
WHERE pv.id_venta = ?");
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="producto"><?php echo $producto->tipoflor;  ?> <strong>$<?php echo number_format($producto->precio, 2) ?></strong></td>
